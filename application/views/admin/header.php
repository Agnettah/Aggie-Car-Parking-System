...
<body class="bg-light" style="font-family: Quicksand;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm sticky-top">
        <div class="navbar-brand mt-1 ml-1">
            <h5><i class="fas fa-car-side text-primary"></i>&nbsp; <span class="text-primary">Aggie</span>PMS Panel</h5>
        </div>
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <h6>
                    <a href="<?=base_url('admin/logout');?>" class="nav-link text-white btn btn-sm bg-primary border-0"
                        id="size">
