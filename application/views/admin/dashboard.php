                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                    <div class="card rounded-0 border-0 shadow-sm bg-dark text-white">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-7">
                                    <h1 class="ml-2"><?=$this->datawork->count_data('add_vehicle',['status='=>1]);?>
                                    </h1>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                    <div class="card rounded-0 border-0 shadow-sm bg-danger text-white">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-7">
                                    <h1 class="ml-2"><?=$this->datawork->count_data('category',['cat_id!='=>NULL]);?>
                                    </h1>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-7">
                                    ...
                                    <h1 class="ml-2"><i
                                            class="KSH">Ksh</i>&nbsp;<?= number_format($this->datawork->column_sum('parking_charge','add_vehicle'), 2);?>
                                    </h1>
                    ...
                    <div class="card rounded-0 border-0 shadow-sm bg-primary text-white">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-7">
                                    <h1 class="ml-2">
                                        <?=$this->datawork->datawork->column_sum('vehicle_limit','category');?></h1>
