            ...
            <div class="row">
                            ...
                            <form action="<?=base_url('admin/category');?>" method="post" class="mt-4">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="parking_area_no" required autofocus>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input onkeypress='return event.charCode >= 48 && event.charCode <= 57' type="text"
                                        class="form-control rounded-0 form-control-sm shadow-none" name="vehicle_limit"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label class="text-muted  m-0 p-0">Parking Charge</label>
                                    <input onkeypress='return event.charCode >= 48 && event.charCode <= 57' type="text"
                                        class="form-control rounded-0 form-control-sm shadow-none" name="parking_charge"
                                        required>
                                </div>
                                <div class="form-group">
                                    <input type="submit" name="send"
                                        class="btn text-white mt-4 btn-block shadow-none border-0 bg-primary rounded-0">
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-4">
                    <div class="card border rounded-0 shadow-sm">
                        <div class="card-header">
                            <div class="text-muted h6 card-title mb-0"><b><i class="fas fa-universal-access"></i>&nbsp;
                                    Details:</b></div>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="list-group-item list-group-item-action">
                                    <div class="d-flex w-100 align-items-center">
                                        ...
                                        <div class="col-auto text-right">
                                            <i class="">Ksh</i>&nbsp; <?= number_format($c->parking_charge,2);?>
                                        </div>
                                    </div>
                                </div>
                                <?php endforeach;?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-2 py-1 align-middle text-right">
                                            <?= number_format($c->vehicle_limit);?></td>
                                        <td class="px-2 py-1 align-middle text-right">
                                            <?= number_format($c->parking_charge,2);?></td>
                                        ...
                                        <td class="px-2 py-1 align-middle text-center">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <i class="far fa-frown"></i>&nbsp; Do you really want to
                                                            delete this category?
                                                        </div>
                                                        <div class="modal-footer">
                                                            <a href="<?= base_url('admin/delete/category/'.$c->cat_id);?>"
                                                                class="btn btn-sm btn-danger shadow-none">&nbsp; Yes
                                                                &nbsp;</a>
                                                            <a href="" class="btn btn-dark btn-sm shadow-none">&nbsp; No
                                                                &nbsp;</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <?php if($c->status==0):?>
                                            <a href="<?=base_url('admin/status/status_active/'.$c->cat_id);?>"
                                                class="btn btn-sm bg-success text-white shadow-none"><small>Activate</small></a>
                                            <?php else:?>
                                            <a href="<?=base_url('admin/status/status_deactivate/'.$c->cat_id);?>"
                                                class="btn btn-sm bg-danger text-white shadow-none"><small>Deactivate</small></a>
                                            <?php endif;?>
                                            <button class="btn btn btn-sm btn-primary rounded-0 edit-category"
                                                type="button" title="Edit Category" data-id="<?=  $c->cat_id?>"><i
                                                    class="fa fa-xs fa-edit"></i></button>
                                            <button type="button" data-toggle="modal" data
                                                class="btn btn-sm btn-danger shadow-none rounded-0"
                                                data-target="#rock<?= $c->cat_id;?>">
        ...
        <div class="modal-content rounded-0">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-sm rounded-0"
                    onclick="$('#edit-modal .modal-body form').submit()">Update</button>
