                ...
                <div class="col-12">
                    <div class="card shadow-sm rounde-0">
                        <div class="card-header">
                            <div class="card-title h6 mb-0"><i class="fas fa-tasks"></i>&nbsp; Manage Vehicle |
                                <small><span class="text-primary">O</span>nly the records of the last 30 days are
                                    available here</small>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <table class="table mt-4 table-bordered table-striped" id="vehicle-tbl">
                                ...
                                <tr>
                                    ...
                                    <td class="px-2 py-1 align-middle text-right">
                                        <?= number_format($m->parking_area_no); ?></td>
                                    <td class="px-2 py-1 align-middle text-right"><i
                                            class="text-warning">KSH</i>&nbsp;<?=number_format($m->parking_charge, 2);?>
                                    </td>
                                    ...
                                    <td class="px-2 py-1 align-middle text-center"><a
                                            href="<?=base_url('admin/vehicle_outgoing/'.$m->id);?>"
                                            class="btn btn-sm shadow-none bg-primary text-white btn-sm rounded-0 btn-sm <?php if($m->status==1){echo "disabled bg-light text-dark border";}?>">Done</a>
                                    </td>
                                </tr>
                                <?php endforeach;?>
                            </table>
