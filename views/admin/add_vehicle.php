        ...
        <div class="col-8 offset-3 mt-5 mr-5">
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <form action="" method="post" class="mt-4">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control rounded-0 form-control-sm shadow-none"
                                                name="vehicle_number" required autofocus>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="vehicle_type"
                                                ...
                                                <option value="<?=$p->vehicle_type;?>"
                                                    <?php if($this->datawork->count_data('add_vehicle',['vehicle_type'=>$p->vehicle_type,'status'=>0])==$p->vehicle_limit){echo "disabled";}?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="parking_area_number"
                                        class="form-control rounded-0 form-control-sm shadow-none">
                                        <option value="" selected disabled>Select Parking Area Number</option>
                                        <?php foreach($parking_area_no as $p):?>
                                        <option value="<?=$p->parking_area_no;?>"
                                            <?php if($this->datawork->count_data('add_vehicle',['vehicle_type'=>$p->vehicle_type,'status'=>0])==$p->vehicle_limit){echo "disabled";}?>>
                                            <?=$p->parking_area_no;?> &#8594; <span>(<?=$p->vehicle_type;?>)</span>
                                        </option>
                                        <?php endforeach;?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="parking_charge"
                                        class="form-control rounded-0 form-control-sm shadow-none">
                                        <option value="" selected disabled>Select Parking Charge</option>
                                        <?php foreach($parking_area_no as $p):?>
                                        <option value="<?=$p->parking_charge;?>"
                                            <?php if($this->datawork->count_data('add_vehicle',['vehicle_type'=>$p->vehicle_type,'status'=>0])==$p->vehicle_limit){echo "disabled";}?>>
                                            Ksh<?=$p->parking_charge;?> &#8594; <span>(<?=$p->vehicle_type;?>)</span>
                                        </option>
                                        <?php endforeach;?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <input type="submit" value="Add Vehicle"
                                        class="mt-4 btn btn-block bg-primary btn-sm rounded-0 text-white shadow-none">
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-5">
                    <div class="card rounded-0 shadow-sm">
                        <div class="card-header">
                            <div class="card-title h6 mb-0"><b><i class="fab fa-staylinked fa-xs"></i>&nbsp; Vehicle
                                    Limitations</b></div>
                        </div>
                        <div class="card-body">
                            <div class="list-group">
                                ...
                                <div class="list-group-item list-group-action">
                                    <div class="d-flex w-100 align-items-center">
                                        <div class="col-auto flex-shrink-1 flex-grow-1 text-truncate">
                                            <?= $c->vehicle_type;?> Limit:</div>
                                        <div class="col-auto flex-shrink-1 flex-grow-1 text-truncate text-right">
                                            <?php if($test==0){echo "<span class='badge badge-danger'>$test</span> "; } else {echo "<span class='badge badge-success'>$test</span> ";}; ?>
                                            out of <?=$c->vehicle_limit;?></div>
                                    </div>
                                </div>
                                <?php endforeach;?>
                            </div>
                ...
                <div class="col-12 mt-3">
                    <div class="card rounded-0 shadow-none">
                        <div class="card-header">
                            <div class="card-title h6 mb-0"><b><i class="fab fa-staylinkfa-th-listed fa-xs"></i>&nbsp;
                                    Current Vehicles</b></div>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-2 py-1 align-middle text-center"><?php if($a->status==0):?>
                                            <small
                                                class="text-white badge badge-primary badge-pill px-3 text-xs"><b>Parked</b></small>
                                            <?php else:?>
                                            <small
                                                class="text-white badge badge-success badge-pill px-3 text-xs"><b>Leaved</b></small>
                                            <?php endif;?></small>
                                        </td>
                                        <td class="px-2 py-1 align-middle text-center">
                                            <button class="btn btn-light btn-sm border bg-light rounded-0 view_receipt"
                                                type="button" data-link="<?= base_url('admin/receipt/'.$a->id) ?>"><i
                                                    class="fas fa-receipt fa-xs"></i> Receipt</button>
...
$(function() {
    ...
    $('.view_receipt').click(function() {
        var nw = window.open($(this).attr('data-link'), '_blank', "width=" + ($(window).width() * .7) +
            ",left=" + ($(window).width() * .15) + ",height=" + ($(window).height() * .8) +
            ",top=" + ($(window).height() * .1))
        nw.document.close()
        setTimeout(() => {
            nw.print()
