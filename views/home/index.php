...
<body class="bg-dark text-light" style="font-family: Quicksand;">
    <div class="container my-3">
        <div class="row">
            <div class="col-lg-12">
                <h4><i class="fas fa-car-side text-primary"></i>&nbsp; <span class="text-primary">A</span>ggie Parking
        ...
        <div class="row">
            <div class="col-lg-6 mx-auto mt-5">
                ...
                <div class="card border-0 shadow-sm mt-4 text-dark">
                    <div class="card-body">
                        <h5 class="h5 text-center"><i class="fas fa-sign-in-alt text-primary"></i>&nbsp; Admin Login
                        </h5>
                        <form action="<?=base_url('home/index');?>" method="post" class="mt-4">
                            <label class="m-0 p-0 text-muted">Username</label>
                            <input type="text" name="username" class="form-control form-control-sm shadow-none"
                                required>
                            ...
                            <input type="password" name="password" class="form-control form-control-sm shadow-none"
                                required>
                            <input type="submit"
                                class="btn btn-block mt-4 text-white bg-primary shadow-none rounded-pill" name="send"
                                value="Login">
                        </form>
                        <div class="row">
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-lg-6 mt-5 mx-auto"><br><br>
                <p class="text-center small mt-4">&copy; <?php echo date("Y"); ?> APMS | Developed in CodeIgniter
                    Version <?= CI_VERSION ?></p>
            </div>
        </div>
    </div>
</body>
